        ...
        with gr.Column():
            with gr.Tabs():
                ...
                with gr.Tab("Performance"):
                    ...
                    self.compile_choice = gr.Dropdown(choices=[("On (up to 20% faster, requires Triton)", "transformer"), ("Off", "")], value=self.compile, label="Compile Transformer Model (slight speed gain, but first generation is slower and potential compatibility issues with some GPUs/Models)", interactive=not self.args.lock_config)
