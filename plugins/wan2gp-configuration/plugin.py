        ...
        with gr.Column():
            with gr.Tabs():
                ...
                with gr.Tab("Performance"):
                    ...
                    self.compile_choice = gr.Dropdown(choices=[("On (up to 20% faster, requires Triton)", "transformer"), ("Off", "")], value=self.compile, label="Compile Models (Transformer + VAE, slight speed gain but first generation is slower)", interactive=not self.args.lock_config)
